// Este archivo debe ir en: api/generate-qr.js
...
exports.handler = async function (event, context) {
    ...
    try {
        ...
        // --- ¡CAMBIO CLAVE AQUÍ para VERCEL! ---
        // Ahora apunta a /api/webhook, la ruta estándar de Vercel Functions.
        const notificationUrl = `https://${event.headers.host}/api/webhook`;
